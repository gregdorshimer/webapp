...
# old: SECRET_KEY = 'django-insecure-fqfbp9vl+=68!r^3tdq66ujd-_@)m(hk6+y*ad*-q35rno135y'
...
RESUME_DIR = BASE_DIR / 'static' / 'pdf'
...
STORAGES = {
    ...
    "staticfiles": {
        # "BACKEND": "whitenoise.storage.CompressedManifestStaticFilesStorage",   <-- caching
